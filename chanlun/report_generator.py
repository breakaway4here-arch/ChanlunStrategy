...
def _serialize_startup_watchlist(watchlist):
    ...
    for w in watchlist:
        ...
        item = {
            ...
            "confirmation_evidence": dict(w.get("confirmation_evidence") or {}),
...
def _serialize_bp(bp):
    ...
    return {
        ...
        "confirmation_evidence": dict(bp.get("confirmation_evidence") or {}),
        "daily_startup_grade": bp.get("daily_startup_grade", ""),
        "daily_startup_label": bp.get("daily_startup_label", ""),
        "daily_startup_warning": bp.get("daily_startup_warning", ""),
        "sublevel_confirm_grade": bp.get("sublevel_confirm_grade", ""),
        "sublevel_confirm_label": bp.get("sublevel_confirm_label", ""),
        "sublevel_confirm_reason": bp.get("sublevel_confirm_reason", ""),
