...
验收覆盖 1440×900、1366×768、390×844，包含：完整/缺价/分歧/研究/过期冲突/无日线/部分量能/长名称/旧版缺 workspace；全部候选、20→25 分页、比较表、搜索有/无/清空、板块筛选/清空、K 线缩放后切层、同股重挂载、手机抽屉焦点和 390→1440→390。M3/M4/M5 未出现可验收控件时明确记录 `pending`。
